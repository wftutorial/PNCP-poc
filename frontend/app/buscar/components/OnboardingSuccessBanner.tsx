...
export function OnboardingSuccessBanner({
  ...
  return (
    <div className="mb-4 p-4 rounded-lg bg-green-50 dark:bg-green-900/10 border border-green-200 dark:border-green-800 flex items-center justify-between gap-3" aria-live="polite">
