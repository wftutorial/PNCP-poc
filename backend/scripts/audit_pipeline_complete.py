...
SECTOR_FN_HINTS: dict[str, list[str]] = {
    ...
    "software_desenvolvimento": ["saas", "cloud", "hospedagem", "api", "sistema de informacao", "consultoria de ti"],
    "software_licencas": ["licenca", "microsoft", "adobe", "antivirus", "licenciamento"],
    "engenharia": ["projeto executivo", "art", "crea", "topografia", "projeto basico"],
    "servicos_prediais": ["limpeza", "conservacao", "jardinagem", "portaria", "zeladoria"],
    "medicamentos": ["medicamento", "farmacia", "comprimido", "vacina", "antibiotico"],
    "equipamentos_medicos": ["ambulancia", "tomografo", "ventilador", "protese", "ortese"],
    "insumos_hospitalares": ["insumo hospitalar", "seringa", "cateter", "curativo", "reagente"],
    "vigilancia": ["vigilante", "cftv", "alarme", "cerca eletrica", "monitoramento"],
    "transporte_servicos": ["frete", "transporte escolar", "locacao de veiculo", "onibus", "van"],
    "frota_veicular": ["veiculo", "combustivel", "gasolina", "diesel", "pneu", "frota"],
